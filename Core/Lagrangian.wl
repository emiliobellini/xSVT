...
L4 = G4fun[scalarcov[], Xcov[]] RicciScalarCD[] +
	...
	F4fun[scalarcov[], Xcov[]] epsilonmetricg[\[Alpha],\[Beta],\[Eta],\[Lambda]] epsilonmetricg[\[Mu],\[Nu],\[Kappa],-\[Lambda]] CD[-\[Alpha]]@scalarcov[] CD[-\[Mu]]@scalarcov[] CD[-\[Beta]]@CD[-\[Nu]]@scalarcov[] CD[-\[Eta]]@CD[-\[Kappa]]@scalarcov[];
L5 = G5fun[scalarcov[], Xcov[]] EinsteinCD[-\[Mu], -\[Nu]] CD[\[Mu]]@CD[\[Nu]]@scalarcov[] -
	...
	F5fun[scalarcov[], Xcov[]] epsilonmetricg[\[Alpha],\[Beta],\[Eta],\[Lambda]] epsilonmetricg[\[Mu],\[Nu],\[Kappa],\[Zeta]] CD[-\[Alpha]]@scalarcov[] CD[-\[Mu]]@scalarcov[] CD[-\[Beta]]@CD[-\[Nu]]@scalarcov[] CD[-\[Eta]]@CD[-\[Kappa]]@scalarcov[] CD[-\[Lambda]]@CD[-\[Zeta]]@scalarcov[];
