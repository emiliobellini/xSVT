...
sourcetensors = SelectTensors[$Tensors, "source"];
...
DerivedTensors[#, "prime"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "pprime"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "ppprime"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "pppprime"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "dot"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "ddot"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "dddot"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


DerivedTensors[#, "ddddot"]&/@Union[backtensors, perttensors, funtensors, sourcetensors, SelectTensors[$Tensors, "perturbation gauge"]];


Clear[backtensors, perttensors, funtensors, ktensors, sourcetensors]
