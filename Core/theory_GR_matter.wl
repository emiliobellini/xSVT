...
matterrules = Flatten[{
	...
	MakeRule[{pertvelocitycov[LI[1], i], (pertvelocityvec[LI[1], i] + pertS[LI[1], i] + metric\[Delta][i, j] PD[-j]@pertvelocity[LI[1]]-metric\[Delta][i, j] PD[-j]@pertB[LI[1]])/scale[]}],
	MakeRule[{pertvelocitycov[LI[2], i], (pertvelocityvec[LI[2], i] + pertS[LI[2], i] + metric\[Delta][i, j] PD[-j]@pertvelocity[LI[2]]-metric\[Delta][i, j] PD[-j]@pertB[LI[2]])/scale[]}],
	MakeRule[{pertvelocitycov[LI[3], i], (pertvelocityvec[LI[3], i] + pertS[LI[3], i] + metric\[Delta][i, j] PD[-j]@pertvelocity[LI[3]]-metric\[Delta][i, j] PD[-j]@pertB[LI[3]])/scale[]}],
