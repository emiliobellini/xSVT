...
MaxBytesPrint::usage =
"MaxBytesPrint (default: 20.000) is an option for SVTDecomposition. In Verbose mode it fixes the maximum \
number of bytes for the right hand side of a decomposition rule in order to be printed. If the expression \
exceeds the maximum number of bytes only the left hand side of the rule will be shown.";
