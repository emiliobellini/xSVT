...
EQalphaK = - hubbleC[]^2/scale[]^2 alphaK[] mass2[] +
	...
	(primescalar[]^2*Derivative[0, 1][Kfun][scalar[], X[]])/scale[]^2 +
	...
	(primescalar[]^4*Derivative[0, 2][Kfun][scalar[], X[]])/scale[]^4 +
...
EQalphaKK = - hubbleC[]^2*mass2[]*alphaKK[]/scale[]^2 +
	...
	(primescalar[]^4*Derivative[0, 2][Kfun][scalar[], X[]])/(4*scale[]^4) -
	...
	(primescalar[]^6*Derivative[0, 3][Kfun][scalar[], X[]])/(12*scale[]^6) -
